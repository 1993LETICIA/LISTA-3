...
casa: 
k. Crie uma estrutura para armazenar os dados de cada eletrodoméstico: nome, 
potencia (real, em kW) e tempo médio ativo por dia (real, em horas)
l. Permite listar em tela e salvar em um arquivo.
m. Permita buscar pelo seu nome.
n. Permita buscar pelos eletrodomésticos que gastam mais que um valor X.
o. Calcule e mostre o consumo diário e mensal da casa em kW e R$. Para mostrar 
em R$ receba o valor do kW/h.
p. Organize tudo em uma aplicação que exiba um menu as opções de preencher 
